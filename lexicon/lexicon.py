...
lexicon = {
    ...
    "first_date_excel": f"Отправь мне дату и время начала периода в формате указанном ниже:\n\n"
    f"<b>{current_date}</b>",
    "last_date_excel": f"Отправь мне дату и время конца периода в формате указанном ниже:\n\n"
    f"<b>{current_date}</b>",
}
